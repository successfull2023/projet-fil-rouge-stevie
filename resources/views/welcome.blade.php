...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <a href="#" class="logo"> <div class="img">
            <img
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="#menu">Nos services</a></li>
          <li><a href="#events">Notre proposition de menu</a></li>
          <li><a href="#chefs">Nos tarifs</a></li>
          <li><a href="#gallery">Contact</a></li>
        </ul>
      </nav><!-- .navbar -->

      <a class="btn-book-a-table" href="#book-a-table">Notre gallerie d'images</a>

    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="row">
          ...
          <!-- Formulaire ajout du Produit -->

          <div class="col-12">
            <div class="card recent-sales overflow-auto">
              <div class="card-body">
                <h5 class="card-title">ajout d'un nouveau produitt</h5>

              <form method="POST" action="{{route('produit.update', $produits->id )}}" class="row g-3">
                @method('PATCH')
                @csrf
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <label for="inputName5" class="form-label">prix</label>
